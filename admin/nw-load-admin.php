 ...
 * Define login page
 */
define('NW_ADMIN_HEADER' ,   NW_ADMIN_DYN . 'nw-admin-header.inc');
/**
 * Define login page
 */
define('NW_ADMIN_FOOTER' ,   NW_ADMIN_DYN . 'nw-admin-footer.inc');
 ...
 * Admin Classes
 */
define('NW_ADMIN_CLASS', NW_ADMIN_CODE . 'admin-gen-class.php');
/**
 * Admin Functions
 */
define('NW_ADMIN_FUNCTION', NW_ADMIN_CODE . 'admin-gen-functions.php');
